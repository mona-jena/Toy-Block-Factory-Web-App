...
namespace ToyBlockFactoryTests
{
    public class PricingCalculatorTests
    {
        ...
        private readonly LineItemsCalculator _lineItemsCalculator;

        public PricingCalculatorTests()
        {
            _lineItemsCalculator = new LineItemsCalculator();
            var toyBlockFactory = new ToyBlockFactory(_lineItemsCalculator);
        ...
        {
            var invoiceLine = _lineItemsCalculator.GenerateLineItems(_customerOrder).ToList();
